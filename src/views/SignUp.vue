      ...
      <div class="wrap-login100">
        ...
        <form class="signup">
          ...
          <div class="wrap-input100 validate-input" data-validate="Username is required ">
            <input class="input100" type="username" id='username' name="username" placeholder="Username" v-model='username' required>
          ...
          <div class="container-login100-form-btn">
            <input type="submit" class="login100-form-btn" id="signUp" name="signup_submit" value="Sign Up" @click.prevent="register">
          </div>
